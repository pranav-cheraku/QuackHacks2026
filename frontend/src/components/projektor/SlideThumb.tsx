    ...
    case "title":
      return (
        <div className="relative w-full h-full bg-white p-3 overflow-hidden">
          ...
          <div className="mt-3 text-[18px] leading-tight font-extrabold text-ink">
            Strategy
            <br />
            Review
          </div>
          <div className="mt-2 text-[7px] text-muted-foreground leading-tight">
            Aligning Q4 priorities across product, sales, and ops.
          </div>
          <div className="absolute bottom-2 left-3 flex items-center gap-1.5">
            ...
            <div>
              ...
              <div className="text-[5px] text-muted-foreground leading-none mt-0.5">
                Head of Strategy
              </div>
            </div>
          </div>
    ...
    case "stats":
      return (
        <div className="w-full h-full bg-white p-3 flex flex-col">
          <div className="text-[7px] font-mono uppercase tracking-wider text-muted-foreground">
            By the Numbers
          </div>
          <div className="flex-1 grid grid-cols-3 gap-2 mt-2 items-center">
            {[
              ...
              <div key={l}>
                ...
                <div className="text-[6px] mt-1 text-muted-foreground uppercase tracking-wide">
                  {l}
                </div>
              </div>
            ))}
            ...
            {[28, 42, 38, 55, 61, 72, 68, 84].map((v, i) => (
              <div
                ...
                style={{
                  height: `${v}%`,
                  background:
                    i > 4 ? "var(--accent-teal)" : "oklch(0.85 0.02 192)",
                }}
              />
            ))}
          </div>
          ...
          <div className="mt-2 space-y-2">
            {[
              ...
              <div key={i} className="flex items-start gap-2">
                <div
                  className="text-[10px] font-extrabold w-3"
                  style={{ color: "var(--accent-teal)" }}
                >
                  {i + 1}
                </div>
    ...
    case "closing":
      return (
        <div className="w-full h-full bg-white flex flex-col items-center justify-center">
          ...
          <div className="text-[7px] mt-1 font-mono text-muted-foreground">
            — the team
          </div>
        </div>
      );
